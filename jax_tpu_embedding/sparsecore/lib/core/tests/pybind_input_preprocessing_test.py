...
class InputPreprocessingTableStackingTest(parameterized.TestCase):
  ...
  def test_multi_process_fdo(self):
...
class InputPreprocessingTest(parameterized.TestCase):
  ...
  def test_mean_combiner(self):
    ...
    with self.subTest(name="RowPointerEquality"):
      ...
      expected_ragged_table_row_pointers = np.array(
          [
              0,
              0,
              1,
      ...
      np.testing.assert_equal(
          ...
          expected_ragged_table_row_pointers,
      )
    ...
    with self.subTest(name="EmbeddingIdsEqaulity"):
      ...
      expected_ragged_table_embedding_ids[0] = 1
      expected_ragged_table_embedding_ids[8] = 0
      expected_ragged_table_embedding_ids[256] = 0
      expected_ragged_table_embedding_ids[264] = 0
      expected_ragged_table_embedding_ids[272] = 1
      expected_ragged_table_embedding_ids[512] = 0
      expected_ragged_table_embedding_ids[520] = 1
      expected_ragged_table_embedding_ids[528] = 1
      expected_ragged_table_embedding_ids[536] = 0
      expected_ragged_table_embedding_ids[768] = 0
      expected_ragged_table_embedding_ids[776] = 0
      expected_ragged_table_embedding_ids[784] = 0
      expected_ragged_table_embedding_ids[792] = 1
      expected_ragged_table_embedding_ids[1024 + 0] = 0
      expected_ragged_table_embedding_ids[1024 + 256] = 0
      expected_ragged_table_embedding_ids[1024 + 264] = 0
      expected_ragged_table_embedding_ids[1024 + 272] = 0
      expected_ragged_table_embedding_ids[1024 + 280] = 0
      expected_ragged_table_embedding_ids[1024 + 512] = 0
      expected_ragged_table_embedding_ids[1024 + 520] = 1
      expected_ragged_table_embedding_ids[1024 + 528] = 0
      expected_ragged_table_embedding_ids[1024 + 536] = 0
      expected_ragged_table_embedding_ids[1024 + 768] = 0
      expected_ragged_table_embedding_ids[1024 + 776] = 1
      expected_ragged_table_embedding_ids[1024 + 784] = 0
      expected_ragged_table_embedding_ids[1024 + 792] = 0
      ...
      expected_singleton_table_embedding_ids[0] = 1
      expected_singleton_table_embedding_ids[8] = 0
      expected_singleton_table_embedding_ids[256] = 0
      expected_singleton_table_embedding_ids[264] = 1
      expected_singleton_table_embedding_ids[512] = 0
      expected_singleton_table_embedding_ids[520] = 0
      expected_singleton_table_embedding_ids[768] = 0
      expected_singleton_table_embedding_ids[776] = 0
      expected_singleton_table_embedding_ids[1024 + 0] = 0
      expected_singleton_table_embedding_ids[1024 + 8] = 0
      expected_singleton_table_embedding_ids[1024 + 256] = 0
      expected_singleton_table_embedding_ids[1024 + 264] = 1
      expected_singleton_table_embedding_ids[1024 + 512] = 0
      expected_singleton_table_embedding_ids[1024 + 520] = 1
      expected_singleton_table_embedding_ids[1024 + 768] = 0
      expected_singleton_table_embedding_ids[1024 + 776] = 0
    ...
    with self.subTest(name="SampleIdsEqaulity"):
      ...
      expected_ragged_table_sample_ids[0] = 0
      expected_ragged_table_sample_ids[8] = 0
      expected_ragged_table_sample_ids[256] = 0
      expected_ragged_table_sample_ids[264] = 0
      expected_ragged_table_sample_ids[272] = 0
      expected_ragged_table_sample_ids[512] = 0
      expected_ragged_table_sample_ids[520] = 0
      expected_ragged_table_sample_ids[528] = 0
      expected_ragged_table_sample_ids[536] = 0
      expected_ragged_table_sample_ids[768] = 0
      expected_ragged_table_sample_ids[776] = 0
      expected_ragged_table_sample_ids[784] = 0
      expected_ragged_table_sample_ids[792] = 0
      expected_ragged_table_sample_ids[1024 + 0] = 0
      expected_ragged_table_sample_ids[1024 + 256] = 0
      expected_ragged_table_sample_ids[1024 + 264] = 0
      expected_ragged_table_sample_ids[1024 + 272] = 0
      expected_ragged_table_sample_ids[1024 + 280] = 0
      expected_ragged_table_sample_ids[1024 + 512] = 0
      expected_ragged_table_sample_ids[1024 + 520] = 0
      expected_ragged_table_sample_ids[1024 + 528] = 0
      expected_ragged_table_sample_ids[1024 + 536] = 0
      expected_ragged_table_sample_ids[1024 + 768] = 0
      expected_ragged_table_sample_ids[1024 + 776] = 0
      expected_ragged_table_sample_ids[1024 + 784] = 0
      expected_ragged_table_sample_ids[1024 + 792] = 0
      ...
      expected_singleton_table_sample_ids[0] = 1
      expected_singleton_table_sample_ids[8] = 0
      expected_singleton_table_sample_ids[256] = 0
      expected_singleton_table_sample_ids[264] = 1
      expected_singleton_table_sample_ids[512] = 0
      expected_singleton_table_sample_ids[520] = 1
      expected_singleton_table_sample_ids[768] = 1
      expected_singleton_table_sample_ids[776] = 0
      expected_singleton_table_sample_ids[1024 + 0] = 0
      expected_singleton_table_sample_ids[1024 + 8] = 1
      expected_singleton_table_sample_ids[1024 + 256] = 0
      expected_singleton_table_sample_ids[1024 + 264] = 1
      expected_singleton_table_sample_ids[1024 + 512] = 0
      expected_singleton_table_sample_ids[1024 + 520] = 1
      expected_singleton_table_sample_ids[1024 + 768] = 1
      expected_singleton_table_sample_ids[1024 + 776] = 0
      assert_equal_coo_buffer(
          row_pointers[self.singleton_input_table_spec.name],
          sample_ids[self.singleton_input_table_spec.name],
    ...
    with self.subTest(name="GainsEqualityTest"):
      ...
      expected_ragged_table_gains[0] = 1.0
      expected_ragged_table_gains[8] = 1.0
      expected_ragged_table_gains[256] = 1.0
      expected_ragged_table_gains[264] = 1.0
      expected_ragged_table_gains[272] = 1.0
      expected_ragged_table_gains[512] = 1.0
      expected_ragged_table_gains[520] = 1.0
      expected_ragged_table_gains[528] = 1.0
      expected_ragged_table_gains[536] = 1.0
      expected_ragged_table_gains[768] = 1.0
      expected_ragged_table_gains[776] = 1.0
      expected_ragged_table_gains[784] = 1.0
      expected_ragged_table_gains[792] = 1.0
      expected_ragged_table_gains[1024 + 0] = 1.0
      expected_ragged_table_gains[1024 + 256] = 1.0
      expected_ragged_table_gains[1024 + 264] = 1.0
      expected_ragged_table_gains[1024 + 272] = 1.0
      expected_ragged_table_gains[1024 + 280] = 1.0
      expected_ragged_table_gains[1024 + 512] = 1.0
      expected_ragged_table_gains[1024 + 520] = 1.0
      expected_ragged_table_gains[1024 + 528] = 1.0
      expected_ragged_table_gains[1024 + 536] = 1.0
      expected_ragged_table_gains[1024 + 768] = 1.0
      expected_ragged_table_gains[1024 + 776] = 1.0
      expected_ragged_table_gains[1024 + 784] = 1.0
      expected_ragged_table_gains[1024 + 792] = 1.0
      ...
      expected_singleton_table_gains[0] = 1.0
      expected_singleton_table_gains[8] = 1.0
      expected_singleton_table_gains[256] = 1.0
      expected_singleton_table_gains[264] = 1.0
      expected_singleton_table_gains[512] = 1.0
      expected_singleton_table_gains[520] = 1.0
      expected_singleton_table_gains[768] = 1.0
      expected_singleton_table_gains[776] = 1.0
      expected_singleton_table_gains[1024 + 0] = 1.0
      expected_singleton_table_gains[1024 + 8] = 1.0
      expected_singleton_table_gains[1024 + 256] = 1.0
      expected_singleton_table_gains[1024 + 264] = 1.0
      expected_singleton_table_gains[1024 + 512] = 1.0
      expected_singleton_table_gains[1024 + 520] = 1.0
      expected_singleton_table_gains[1024 + 768] = 1.0
      expected_singleton_table_gains[1024 + 776] = 1.0
