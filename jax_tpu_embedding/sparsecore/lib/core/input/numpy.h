...
class NumpyArrayInput {
  py::list& features;
  py::list& feature_weights;
  // Technically this is not part of the input and will be eventually replaced
  // with a C++ struct in the main preprocessing library.
