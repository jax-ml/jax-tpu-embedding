...
TEST_F(TableStackingTest, MultiProcessStackingFeatureFirst) {
  PreprocessSparseDenseMatmulInputOptions options{
      .local_device_count = 1,
      .global_device_count = 2,
      .num_sc_per_device = 4,
      .feature_stacking_strategy = FeatureStackingStrategy::kFeatureFirst};
...
TEST_F(TableStackingTest, MultiProcessStackingScFirst) {
  PreprocessSparseDenseMatmulInputOptions options{
      .local_device_count = 1,
      .global_device_count = 2,
      .num_sc_per_device = 4,
      .feature_stacking_strategy = FeatureStackingStrategy::kScFirst};
...
TEST_F(TableStackingTest, SingleProcessSingleDeviceScFirst) {
  PreprocessSparseDenseMatmulInputOptions options{
      .local_device_count = 1,
...
TEST_F(TableStackingTest, SingleProcessSingleDeviceFeatureFirst) {
  PreprocessSparseDenseMatmulInputOptions options{
      .local_device_count = 1,
      .global_device_count = 1,
      .num_sc_per_device = 4,
...
TEST_F(TableStackingTest, MultiChipScFirst) {
  PreprocessSparseDenseMatmulInputOptions options{
...
TEST_F(TableStackingTest, MultiChipFeatureFirst) {
  PreprocessSparseDenseMatmulInputOptions options{
      .local_device_count = 2,
      .global_device_count = 2,
      .num_sc_per_device = 4,
