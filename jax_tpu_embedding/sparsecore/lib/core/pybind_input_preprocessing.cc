...
py::tuple PyPreprocessSparseDenseMatmulInput(
    ...
    bool enable_minibatching, int sparsecore_sublane_count,
...
py::tuple PyNumpyPreprocessSparseDenseMatmulInput(
  ...
  return PyPreprocessSparseDenseMatmulInput(
      ...
      enable_minibatching, sparsecore_sublane_count, all_reduce_interface);
}
...
PYBIND11_MODULE(pybind_input_preprocessing, m) {
  ...
  m.def("preprocess_sparse_dense_matmul_input",
        ...
        py::arg("sparsecore_sublane_count") = 8,
