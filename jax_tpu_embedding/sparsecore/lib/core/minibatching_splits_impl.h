...
// bit represents a split. Modifies the original unique id count per bucket with
// combined counts. Combines values bottom up starting with subtree of size 2.
// For e.g.
...
// For example 0b1100011 represents a split between {0,1}, {2,3}, {6,7}, {3,4}
