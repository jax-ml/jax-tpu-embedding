...
def tpu_sparse_dense_matmul(
  ...
  sharding_strategy = embedding_utils.sharding_strategy_to_enum(sharding_strategy)
...
def tpu_sparse_dense_matmul_grad(
  ...
  gradients = embedding_utils.stack_embedding_gradients(activation_gradients, feature_specs)
...
def init_embedding_variables(
  ...
  Raises:
    ValueError: if there is duplicate table name.
  """
