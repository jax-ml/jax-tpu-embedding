...
class DequeueOutput(NamedTuple):
  ...
  Attributes:
    ...
    deduplication_tuple: A `DeduplicationTuple` namedTuple.
  """
...
class TPUEmbedding(object):
  ...
  def apply_gradients(self,
    ...
    def _gradients_fn(
      ...
      # default types.
      if self._dedup_tuple_mask.tensor_shape.dim[0].size == 0:
  ...
  def dequeue(self, name: Optional[str] = None) -> NestedTfTensor:
    ...
    if self._dedup_tuple_mask.tensor_shape.dim[0].size == 0:
      ...
      tuple_integers, tuple_floats = jax2tf.call_tf(_dedup_fn)()
